...
export default function StarredRecord({ bug }) {
    if (!bug) {
                ...
                <div className="row h-100">
                    <div className="col-12 rounded">
                        <div className="card p-3 shadow-sm mb-3">
                            <h1 className='fw-bolder'>Starred Records</h1>
                            <p className='text-black fs-6'><span className='text-bg-dark fst-italic'>CODEX</span> maintains a user centric bug starred history record for future purposes of the users ease.</p>
